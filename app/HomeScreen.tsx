    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View style={styles.homeContainer}>
        ...
        <View style={styles.card}>
          ...
          <Link href="/dayRegister" style={styles.actionButtonText}>Ver ultimo day</Link>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton}>
            <Link href="/weekRegister" style={styles.actionButtonText}>Ver ultima semana</Link>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton}>
            <Link href="/monthRegister" style={styles.actionButtonText}>Ver ultimo mes</Link>
          </TouchableOpacity>
        </View>
